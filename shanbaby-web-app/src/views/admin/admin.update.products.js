    ...
    if (color_code.length > 0 && color_name.length > 0) {
      if (this.isColor(color_code)) {
        this.setState({
          colors: [
            ...this.state.colors,
            { name: color_name, code: color_code },
          ],
          color_code: "",
          color_name: "",
        });
            ...
            <div className="row">
              <div className="col-12">
                <h5 className="text-dark bold-normal py-2 bg-white shadow-sm px-2 mt-3 rounded">
                  Products
                  <span className={`badge mx-2 badge-success`}>Update</span>
                </h5>
              </div>
              <div className="col-12">
                        ...
                        <div class="row mx-1">
                          {images.map((image, i) => {
                            return (
                              <div
                                key={i}
                                className="mb-3 img-wrap column mx-2"
                              >
                                <img
                                  className="rounded"
                                  src={Config.setImage(image)}
                                  height={140}
                                />
                                <span
