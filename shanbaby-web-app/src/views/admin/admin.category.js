...
class AdminCategory extends Component {
            ...
            <div className="row">
              <div className="col-12">
                <h5 className="text-dark bold-normal py-2 bg-white shadow-sm px-2 mt-3 rounded">
                  Product Categories
                  <span
                    className={`badge mx-2 badge-${
                      update_mode ? "info" : "success"
                    }`}
                  >
                    {update_mode ? "Update" : "Add"} Mode
                  </span>
                </h5>
              </div>
              <div className="col-12">
                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-2">
                  ...
                  >
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <h6 className="form-label pt-2 pb-3">
                          Upload Banner Image
                        </h6>
                        ...
                        {uploaded_image.length > 0 && files.length == 0 && (
                          <div className="mb-3 img-wrap">
                            ...
                            />
                            <span
                              className="text-white badge badge-danger close-btn"
                              onClick={() =>
                                this.setState({ uploaded_image: "" })
                              }
                            >
                              Remove
                              <FontAwesomeIcon
                        ...
                        <div className="d-flex">
                          <button
                            className="px-2 btn btn-dark  btn-sm bold-normal ml-auto"
                            type="submit"
                          >
                            <FontAwesomeIcon
                              icon={update_mode ? faSave : faPlus}
                            />
                            {update_mode ? " Save Changes" : " Add Category"}
                          </button>
                          {!update_mode && (
                            <button
                              className="px-2 btn btn-secondary  btn-sm bold-normal ml-2"
                              type="submit"
                            >
                ...
                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-2">
                  ...
                  <div className="table-responsive px-2">
                    <table className="table table-stripped">
                      ...
                      <tbody>
                        {categories.map((item) =>
                          this.renderCategoryTableItem(item)
                        )}
                      </tbody>
                    </table>
                  </div>
  ...
  validate = () => {
    ...
    if (
      ...
      this.state.uploaded_image.length == 0
    ) {
      errors.image = "Banner image can not be empty";
      count++;
    } else {
