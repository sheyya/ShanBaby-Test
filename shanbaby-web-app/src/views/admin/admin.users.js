              ...
              <div className="col-12">
                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-2">
                  ...
                  <div className="table-responsive px-2">
                    <table className="table table-stripped" id="userTable">
                      <thead>
                        <tr>
  ...
  downloadAllUsers = () => {
    if (this.state.startDate == null || this.state.endDate == null) {
      ...
      let col = [
          ...
          { dataKey: "jdate", header: "Join Date" },
        ],
        doc = new jsPDF();
      doc.page = 1;
      ...
      var options = {
        ...
        columnStyles: {
          ...
          name: { columnWidth: 50 },
          email: { columnWidth: 80 },
          jdate: { columnWidth: 30 },
        },
      ...
      this.state.users.map((item) => {
        let b = {
          ...
          email: item.email,
          jdate: moment(new Date(item.created_at)).format("YYYY MMM DD"),
        };

        var bool1 = moment(new Date(item.created_at)).isAfter(
          this.state.startDate
        );
        var bool2 = moment(new Date(item.created_at)).isBefore(
          this.state.endDate
        );
        console.log(bool1);
        console.log(bool2);
