...
class SignUp extends Component {
  ...
  checkAllFields() {
    var Errors = 0;
    if (this.state.uFname === null || this.state.uFname === undefined) {
      console.log("Fname");
      Errors++;
    } else if (this.state.uLname === null || this.state.uLname === undefined) {
      console.log("Lname");
      Errors++;
    } else if (this.state.uEmail === null || this.state.uEmail === undefined) {
      console.log("Email");
      Errors++;
    } else if (this.state.uPass === null || this.state.uPass === undefined) {
  ...
  async onRegister(e) {
    ...
    if (this.checkAllFields() === false) {
      ...
      switch (status) {
        // success
        case 201:
          await C_Config.showAlert("Successful! Please Login.", "Done!");
                ...
                <div className="col-lg-8">
                  <div className="register-form">
                    ...
                    >
                      <div className="group-input col-md-6">
                        ...
                        <input
                          ...
                          onChange={(e) => this.onChangeuFname(e)}
                        />
                      </div>
                      <div className="group-input col-md-6">
                        ...
                        <input
                          ...
                          required
                          onChange={(e) => this.onChangeuLname(e)}
                        />
                      </div>
                      ...
                      <div className="group-input col-md-6 SignUp_div_no_bt_mg">
                        ...
                        <input
                          ...
                          required
                          name="uConPass"
                          value={this.state.uConPass}
                          onChange={(e) => this.onChangeuConPass(e)}
                        />
                      </div>
                      <div className="group-input col-md-12">
                        <p
                          className="SignUp_password_not_match"
                          style={{
                            display:
                        ...
                        >
                          Password and Confrim Password did not match
                        </p>
                      </div>
                      <div className="group-input col-md-12">
                        <center>
                    ...
                    <div className="switch-login">
                      <Link to="/signin" className="or-login">
                        Or Sign In
                      </Link>
                    </div>
                  </div>
