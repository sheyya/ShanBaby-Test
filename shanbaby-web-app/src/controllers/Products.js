...
export const insertProduct = (files, data) => {
  ...
  return new Promise((resolve, reject) => {
    return axios
      .post(`${Config.host}${Config.port}/product/insert`, formdata)
      .then((result) => {
...
export const updateproduct = (files, data) => {
  ...
  return new Promise((resolve, reject) => {
    return axios
      .patch(`${Config.host}${Config.port}/product/update/${data.id}`, formdata)
      .then((result) => {
...
export const deleteProduct = (id, token, type) => {
  return new Promise((resolve, reject) => {
    return axios
      .delete(`${Config.host}${Config.port}/product/delete/${id}`, {
