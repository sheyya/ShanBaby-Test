...
class Footer extends React.Component {
  ...
  onSubscribe = (e) => {
    ...
    if (email.length > 0) {
      ...
      return Util.newsLetterSubscripton(email)
        .then((result) => {
          C_Config.showAlert("Successfully Subscribe");
          this.setState({
            email: "",
            loading: false,
          });
        ...
        .catch((err) => {
          ...
          console.log(err);
          C_Config.setErrorToast("Something went wrong");
        });
    }
    this.setState({
      email: "",
            ...
            <div className="col-lg-2 offset-lg-1">
              <div className="footer-widget">
                ...
                <ul>
                  ...
                  <li>
                    <Link to="/pp">Privacy Policies</Link>
                  </li>
                  <li>
              ...
              <div className="newslatter-item">
                ...
                >
                  <input
                    ...
                    onChange={(e) => this.onEmailcganhe(e)}
                    required
                  />
